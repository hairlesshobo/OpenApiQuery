...
> https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part2-url-conventions.html";
        ...
        public bool Process(OperationProcessorContext context)
        {
            ...
            if (parameters.Count() == 1)
            {
                ...
                JsonSchema optionsSchema = JsonSchema.FromType(typeof(OpenApiQueryOptionsDoc));
                var props = optionsSchema.ActualProperties;
                ...
                Type resultType = typeof(OpenApiQueryApplyResultDoc<>).MakeGenericType(new Type[] { queryType });
